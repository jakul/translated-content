...
<dl><dd><strong>Sus etiquetas son</strong>: <code>&#x3C;colgroup></code> y <code>&#x3C;/colgroup></code> (la de cierre es opcional).</dd></dl>
...
<dl><dd><strong>Puede contener</strong>: Cero o más elementos <a href="es/HTML/Elemento/col">col</a>.</dd></dl>
