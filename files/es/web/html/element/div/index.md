...
<dl><dd><strong>Sus etiquetas son</strong>: <code>&#x3C;div></code> y <code>&#x3C;/div></code> (ambas obligatorias).</dd><dd><strong>Está definido como</strong>: <a href="https://developer.mozilla.org/es/docs/Web/HTML/Block-level_elements">Elemento en bloque</a>.</dd></dl>

<dl><dd><strong>Crea una caja</strong>: En bloque.</dd><dd><strong>Puede contener</strong>: Texto, y/o cero o más elementos <a href="es/HTML/Elemento/Tipos_de_elementos#enbloque">en bloque</a> o <a href="es/HTML/Elemento/Tipos_de_elementos#enlinea">en linea</a>.</dd></dl>
