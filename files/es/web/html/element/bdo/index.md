...
<dl><dd><strong>Sus etiquetas son</strong>: &#x3C;bdo> y &#x3C;/bdo> (ambas obligatorias).</dd></dl>

<dl><dd><strong>Crea una caja</strong>: En línea.</dd></dl>

<dl><dd><strong>Está definido como</strong>: <a href="es/HTML/Elemento/Tipos_de_elementos#especial">Elemento especial</a> y por lo tanto <a href="es/HTML/Elemento/Tipos_de_elementos#en_l.C3.ADnea">en línea</a>.</dd></dl>
