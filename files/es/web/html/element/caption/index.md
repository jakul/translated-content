...
<dl><dd><strong>Sus etiquetas son</strong>: <code>&#x3C;caption></code> y <code>&#x3C;/caption></code> (ambas obligatorias).</dd></dl>

<dl><dd><strong>Crea una caja</strong>: .</dd></dl>

<dl><dd><strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#para_tablas">para tablas</a>.</dd></dl>
