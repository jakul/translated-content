...
<dl><dd><strong>Sus etiquetas son</strong>: &#x3C;cite> y &#x3C;/cite> (ambas obligatorias)</dd><dd><strong>Está definido como</strong>: <a href="es/HTML/Elemento/Tipos_de_elementos#defrase">Elemento de frase</a>, y por lo tanto <a href="es/HTML/Elemento/Tipos_de_elementos#enlinea">en línea</a>.</dd></dl>

<dl><dd><strong>Crea una caja</strong>: En línea.</dd><dd><strong>Puede contener</strong>: Text y/o cero o más elementos <a href="es/HTML/Elemento/Tipos_de_elementos#enlinea">en línea</a>.</dd></dl>
