...
<dl><dd><strong>Sus etiquetas son</strong>: <code>&#x3C;hr/></code> (solo tiene una).</dd></dl>

<dl><dd><strong>Crea una caja</strong>: <a href="es/HTML/Elemento/Tipos_de_elementos#en_bloque">en bloque</a>.</dd></dl>

<dl><dd><strong>Está definido como</strong>: <a href="es/HTML/Elemento/Tipos_de_elementos#en_bloque">en bloque</a>.</dd></dl>

<dl><dd><strong>Puede contener</strong>: Nada, es un "elemento vacío" del un Glosario.</dd></dl>
