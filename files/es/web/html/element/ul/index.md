...
<dl><dd><strong>Sus etiquetas son</strong>: <code>&#x3C;ul> y &#x3C;/ul></code> (ambas obligatorias).</dd><dd><strong>Está definido como</strong>: Elemento <a href="es/HTML/Elemento/Tipos_de_elementos#delista">para listas</a>.</dd></dl>

<dl><dd><strong>Crea una caja</strong>: En bloque.</dd><dd><strong>Puede contener</strong>: Uno o más elementos <a href="es/HTML/Elemento/li">li</a></dd></dl>
